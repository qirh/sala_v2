...
<div>
    ...
    <br />
    Thanks for being part of the Saleh Inc. journey. It's been exciting so far.
    <br />
    <br />
    ...
    <img width="300" height="400" src="/assets/training_1.jpeg" alt="" />

    <h3>a quick highlight of Weeks 2-9</h3>
    <img width="600" height="338" src="/assets/training_2.jpg" alt="" />

    <h3>Week 10 -- despite challenging market conditions, we made it out of bed that day</h3>
    <img width="300" height="400" src="/assets/training_3.jpeg" alt="" />
    ...
    <img width="300" height="400" src="/assets/training_4.jpeg" alt="" />

    <h1>Logistics: how to track me</h1>
    <ul>
        <li>For maximum stakeholder visibility and transparency, I encourage all our shareholders to come out and see me in person actually running the marathon.</li>
        <li>The marathon is this Sunday. <b>Nov 2, 2025</b>.</li>
        <li>Here is the <a href="https://webassets.nyrr.org/nyrrwebsiteassets/TCSNYCM25_Map_Course_080625_M_OL.pdf" target="_blank" rel="noopener noreferrer">course map</a></li>
        <li>My bib number is <b>27769</b>.
            <ul>
                ...
                <li>Or through the tracking app from the race organizers <a href="https://www.nyrr.org/tcsnycmarathon/race-day/mobile-app" target="_blank" rel="noopener noreferrer">link</a>.</li>
            </ul>
        </li>
        <li>I am part of wave 3, which starts at 10:20am. My goal is an 8 min/mile pace, but realisticly, it will be closer to 8:30 min/mile with me getting slower the further I am in the race, you know what they say, no company is perfect.</li>
        <li>For your convenience, see Q4 Performance Metrics. i.e. a best-effort estimate of expected marathon performance</li>
    </ul>
    <br />
